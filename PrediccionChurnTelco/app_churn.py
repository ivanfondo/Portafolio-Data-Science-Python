...
def load_assets():
    try:
        assets = joblib.load('PrediccionTelcoChurn/modelo_churn_final.pkl')
        model = assets['model']
        features = assets['features'] 
        df_modelo = pd.read_csv('PrediccionTelcoChurn/datos_test_dashboard.csv', index_col=0) 
        df_visual = pd.read_csv('PrediccionTelcoChurn/TelcoChurn.csv', index_col=0) 
